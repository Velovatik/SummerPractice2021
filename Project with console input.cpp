...
int main()
{
    ...
    int forcontinue = 1; //Переменная, отвечающая за повторы цикла
    int let = 0; //Счетчик количества букв в строке для теста, если let = 0, то просит ввести текст снова
    do{
        int forcontinue = 0; //Переменная, отвечающая за повторы цикла
